...
class MetaCorgiSnacks
  ...
  #   new_info_method = "get_#{method_name}_info"
  #   new_tastiness_method = "get_#{method_name}_tastiness"
  #   method_name.capitalize!
  #   info = @snack_box.send(new_info_method, @box_id)
  #   tastiness = @snack_box.send(new_tastiness_method, @box_id)
